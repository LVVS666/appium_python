...
def test_registration_in_phone_to_russian(driver_android):
...
def test_registration_in_phone_to_belarussia(driver_android):
...
def test_registration_in_phone_to_kazahstan(driver_android):
...
def test_registration_in_phone_to_kirgistan(driver_android):
